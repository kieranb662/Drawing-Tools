...
struct BulletMarkerView: View {
    var tipColor: Color = Color.green
    var tipSize: CGSize = CGSize(width: 40, height: 70)
...
struct BulletMarkerView_Previews: PreviewProvider {
