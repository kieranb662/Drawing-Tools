...
let stemGradient = AngularGradient(gradient: Gradient(
...
let shaftGradient = LinearGradient(gradient: Gradient(
                                    stops: [.init(color: Color(white: 0.0), location: 0),
                                            .init(color: Color(white: 0.2), location: 0.7),
                                            .init(color: Color(white: 0.1), location: 0.9),
                                            .init(color: Color(white: 0.2), location: 1)]),
                                   startPoint: .leading,
                                   endPoint: .trailing)
...
extension DrawingTool where Shaft == BandedShaft<LinearGradient> {
    ...
    static func pen(color: Color,
        ...
        let stem = BrushStem(width: width,
                             fill: stemGradient,
        ...
        return DrawingTool(tip: RoundedTriangleTip.init,
                           stem: stem,
                           shaft: shaft,
                           color: color,
                           opacity: opacity,
